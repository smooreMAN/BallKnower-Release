        ...
        >
          <div className="flex items-start gap-5">
            ...
            <div className="flex-1">
              <h1 className="font-display text-4xl text-bk-white tracking-wide">
                {profile.username}
              </h1>
              ...
              <p className="text-bk-gray-muted text-xs mt-2 break-all">
                User ID: {profile.id}
              </p>
            ...
            <div className="text-right">
              <div className="font-display text-5xl" style={{ color: tier.color }}>
                {profile.elo}
              </div>
      ...
      {profile && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            <div
              key={label}
              className="bg-bk-gray border border-bk-gray-light rounded-xl p-4 text-center"
            >
              <div className={`font-display text-4xl ${color} mb-1`}>
                {value}
              </div>
              <div className="text-bk-gray-muted text-xs uppercase tracking-widest font-bold">
                {label}
              </div>
            </div>
          ))}
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-bk-gray-muted">
                    {t.minElo}–{t.tier === 'diamond' ? '∞' : t.maxElo} Elo
                  </p>
                </div>
            ...
            {Object.entries(sportCounts).map(([sport, count]) => {
              ...
              return (
                <div key={sport} className="text-center p-3 bg-bk-black rounded-xl">
                  ...
                  <div className="text-bk-gray-muted text-xs">
                    {s?.label || sport}
                  </div>
                </div>
              );
